...
watch-resources: ##
	...
	while true; do \
		...
		${OCP_OC} get -n ${NAMESPACE} -o go-template-file=hack/watch.gotemplate --ignore-not-found cephcluster,cephblockpool,cephfilesystem,cephfilesystemsubvolumegroup,cephclient; \
		${OCP_OC} get -n ${NAMESPACE} -o go-template-file=hack/watch.gotemplate --ignore-not-found storageclient,storageclassclaim; \
...
reset: ## Delete some pods
	$(OC_PROVIDER) delete po -l=name=controller-manager
